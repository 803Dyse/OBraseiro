...
<main>
    <div
        class="relative flex items-center justify-center text-center h-[500px] md:h-[954px] overflow-hidden"
        >
        <img
            src="<?= base_url('img/png/imagenFondoBarbacoa.png') ?>"
            alt=""
            class="blur-sm w-full h-full object-cover object-top"
            />
        <div class="absolute inset-0 flex flex-col items-center justify-center">
            <h2
                class="text-4xl md:text-8xl font-bold text-white drop-shadow-2xl"
                id="txtPrincipal"
                >
                ¿Nuevo por aquí? <br />
    ...
    <section
        ...
        <div class="w-full md:w-1/2 text-center">
            ...
            <div class="flex justify-center">
                <a href="<?= base_url('realizarPedido') ?>">
                    <button
        ...
        <div class="w-full md:w-1/2">
            <div class="relative">
                <div
                    class="w-full h-[200px] md:w-[560px] md:h-[295px] relative overflow-hidden rounded-sm shadow-md"
                    >
                    ...
                    <!-- Slides -->
                    <div
                        class="imgSlider absolute top-0 left-0 w-full h-full transition-all duration-300"
                        >
                        <picture>
                            <source
                                media="(max-width: 416px)"
                                srcset="<?= base_url('img/png/barbacoa5movil.png') ?>"
                                />
                            <source
                                ...
                                />
                            <img
                                src="<?= base_url('img/png/barbacoa5resized.png') ?>"
                    ...
                    <div
                        class="imgSlider absolute top-0 left-full w-full h-full transition-all duration-300"
                        >
                        <picture>
                            <source
                                media="(max-width: 416px)"
                                srcset="<?= base_url('img/png/barbacoa3movil.png') ?>"
                                />
                            <source
                                media="(min-width: 417px)"
                                ...
                                />
                            <img
                                src="<?= base_url('img/png/barbacoa3resized.png') ?>"
                                alt="Imagen de barbacoa"
                                class="w-full h-full object-cover"
                                />
                        </picture>
                    ...
                    <div
                        ...
                        <picture>
                            <source
                                media="(max-width: 416px)"
                                srcset="<?= base_url('img/png/barbacoa1movil.png') ?>"
                                />
                            <source
                                media="(min-width: 417px)"
                                ...
                                />
                            <img
                                src="<?= base_url('img/png/barbacoa1resized.png') ?>"
                                alt="Imagen de barbacoa"
                                class="w-full h-full object-cover"
                                />
                        </picture>
        ...
        <div class="flex items-center space-x-4 md:space-x-8 animate-scroll">
            <div class="w-[300px] h-[150px] md:w-[560px] md:h-[295px] rounded-sm shadow-md">
                <picture>
                    ...
                    <img src="<?= base_url('img/png/barbacoa7.png') ?>" alt="Imagen de barbacoa" class="w-full h-full object-cover" />
                </picture>
            </div>
            ...
            <div class="w-[300px] h-[150px] md:w-[560px] md:h-[295px] rounded-sm shadow-md">
                <picture>
                    ...
                    <img src="<?= base_url('img/png/barbacoa8.png') ?>" alt="Imagen de barbacoa" class="w-full h-full object-cover" />
                </picture>
            </div>
            ...
            <div class="w-[300px] h-[150px] md:w-[560px] md:h-[295px] rounded-sm shadow-md">
                <picture>
                    ...
                    <img src="<?= base_url('img/png/barbacoa9.png') ?>" alt="Imagen de barbacoa" class="w-full h-full object-cover" />
                </picture>
            </div>
            ...
            <div class="w-[300px] h-[150px] md:w-[560px] md:h-[295px] rounded-sm shadow-md">
                <picture>
                    ...
                    <img src="<?= base_url('img/png/barbacoa10.png') ?>" alt="Imagen de barbacoa" class="w-full h-full object-cover" />
                </picture>
            </div>
        </div>
    </section>
    ...
    <section
        ...
        <div class="w-full md:w-1/2">
            <div class="relative">
                <img
                    src="<?= base_url('img/png/empleadoEnElTelefono.png') ?>"
